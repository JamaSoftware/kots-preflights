...
supportbundle_macos_arm64(){
	...
	tar zxf airgap-host-preflight_linux.tar.gz -C /tmp
	tar zxf /tmp/airgap-host-preflight_linux/support-bundle/support-bundle_darwin_arm64.tar.gz -C /tmp
	/tmp/support-bundle /tmp/airgap-host-preflight_linux/host-preflight.yml
	cleanup
}
...
supportbundle_macos_x86_64(){
	...
	tar zxf airgap-host-preflight_linux.tar.gz -C /tmp
	tar zxf /tmp/airgap-host-preflight_linux/support-bundle/support-bundle_darwin_amd64.tar.gz -C /tmp
	/tmp/support-bundle /tmp/airgap-host-preflight_linux/host-preflight.yml
	cleanup
}
